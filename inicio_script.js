const products = [
    ...
    { name: 'Pack Lattafa Khamra', price: '€15', image: 'fotos/KHAMRAH.jpg', description: 'Lattafa Khamra es un perfume masculino oriental y especiado, con una apertura cálida de notas de frutas dulces y especias. Su corazón combina florales suaves con un toque amaderado, mientras que el fondo es profundo y sensual, con notas de ámbar, almizcle y madera. Es una fragancia intensa, elegante y duradera, ideal para ocasiones especiales.', type: 'perfumes', quantity: 1 },
